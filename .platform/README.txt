...
they are ALWAYS download from the zip(upload to S3) so local modification is not possible except deploy hook which can be process by .ebextensions
...
REMOVE http-https-proxy.conf under nginx if you don't don't use ssl
