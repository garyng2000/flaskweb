...
$(function () {
    ...
    var backendHostUrl = 'https://oas.garyng.com/_';

    // [START gae_python_firenotes_config]
    // Obtain the following from the "Add Firebase to your web app" dialogue
    // Initialize Firebase
    var config = {
        apiKey: "AIzaSyCW8KMfBzGKkLu8-xrK4VccpvHHiEjMsZ4",
        authDomain: "api-project-883809904121.firebaseapp.com",
        databaseURL: "https://api-project-883809904121.firebaseio.com",
        projectId: "api-project-883809904121",
        storageBucket: "api-project-883809904121.appspot.com",
        messagingSenderId: "883809904121",
        appId: "1:883809904121:web:beecfbbbad1dc0a0e10928",
        measurementId: "G-1RD8H5D2Y2"
    };
        ...
        firebase.auth().onAuthStateChanged(function (user) {
            if (user) {
                ...
                user.getIdToken().then(function (idToken) {
                    userIdToken = idToken;
                    window.firebaseUsrIdToken = idToken;
